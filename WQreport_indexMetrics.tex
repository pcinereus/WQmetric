...
\begin{landscape}
  \begin{figure}[ptbh]
    ...
    \end{minipage}
  %b) AIMS FLNTU\\\includegraphics[align=t,width=0.95\linewidth]{{figures/Exploratory_Data_Analysis/FLNTU/eda.spatial.year.chl_Wet Tropics__Open Coastal_flntu_logA\res.png}}\\[1em]
  \caption[Spatial distribution of eReefs926 Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone][Spatial distribution of AIMS in situ Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Spatial distribution of eReefs926 Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone.
