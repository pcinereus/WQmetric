\section{Index metrics}\label{sec:indexing}
...
\begin{figure}[ptbh]
  ...
  \caption[Temporal distribution of AIMS FLNTU Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Temporal distribution of AIMS FLNTU Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone. Red and Blue symbols represent samples collected in Dry and Wet seasons respectively.
    Green and red shaded banding on a) respectively represent half and twice threshold value (50\% shading) and one-forth and four times threshold value (30\% shading). Traffic-light banding on b-d) indicates
...
\begin{figure}[ptbh]
  ...
  \caption[Temporal distribution of Satellite Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Temporal distribution of Satellite Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone. Red and Blue symbols represent samples collected in Dry and Wet seasons respectively.
    Green and red shaded banding on a) respectively represent half and twice threshold value (50\% shading) and one-forth and four times threshold value (30\% shading). Traffic-light banding on b-d) indicates
...
\begin{figure}[ptbh]
  ...
  \caption[Temporal distribution of eReefs Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Temporal distribution of eReefs Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations  for the Wet Tropics Open Coastal zone. Red and Blue symbols represent samples collected in Dry and Wet seasons respectively.
    Green and red shaded banding on a) respectively represent half and twice threshold value (50\% shading) and one-forth and four times threshold value (30\% shading). Traffic-light banding on b-d) indicates
...
\begin{figure}[ptbh]
  ...
  \caption[Temporal distribution of eReefs926 Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Temporal distribution of eReefs926 Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone. Red and Blue symbols represent samples collected in Dry and Wet seasons respectively.
    Green and red shaded banding on a) respectively represent half and twice threshold value (50\% shading) and one-forth and four times threshold value (30\% shading). Traffic-light banding on b-d) indicates
...
\begin{landscape}
  \begin{figure}[ptbh]
    ...
    \end{minipage}
    \caption[Spatial distribution of AIMS in situ Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Spatial distribution of AIMS in situ Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone.
...
\begin{landscape}
  \begin{figure}[ptbh]
    ...
    \end{minipage}
  \caption[Spatial distribution of Satellite Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Spatial distribution of Satellite Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone.
...
\begin{landscape}
  ...
  \caption[Spatial distribution of eReefs Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Spatial distribution of eReefs Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone.
...
\begin{landscape}
  \begin{figure}[ptbh]
    ...
    \end{minipage}
    \caption[Spatial distribution of eReefs926 Chlorophyll-a and associated indices for the Wet Tropics Open Coastal zone]{Spatial distribution of eReefs926 Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Wet Tropics Open Coastal zone.
...
\begin{landscape}
\begin{figure}[ptbh]
  a) AIMS insitu raw data\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Insitu/eda.spatial.year.chl_Dry Tropics__Midshelf_niskin_logB\res.png}}\\[1em]
  b) AIMS insitu Binary\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Insitu/eda.idx_Binary_spatial.year.chl_Dry Tropics__Midshelf_niskin_naturalA\res.png}}\\[1em]
  c) AIMS insitu fsMAMP\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Insitu/eda.idx_fsMAMP_spatial.year.chl_Dry Tropics__Midshelf_niskin_naturalA\res.png}}\\[1em]
  d) AIMS insitu fsMAMP4\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Insitu/eda.idx_fsMAMP4_spatial.year.chl_Dry Tropics__Midshelf_niskin_naturalA\res.png}}\\[1em]
  \caption[Spatial distribution of AIMS in situ Chlorophyll-a and associated indices for the Dry Tropics Midshelf zone]{Spatial distribution of AIMS insitu Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Dry Tropics Midshelf zone.
...
\begin{landscape}
\begin{figure}[ptbh]
  a) AIMS FLNTU raw data\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/FLNTU/eda.spatial.year.chl_Dry Tropics__Midshelf_flntu_logB\res.png}}\\[1em]
  b) AIMS FLNTU Binary\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/FLNTU/eda.idx_Binary_spatial.year.chl_Dry Tropics__Midshelf_flntu_naturalA\res.png}}\\[1em]
  c) AIMS FLNTU fsMAMP\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/FLNTU/eda.idx_fsMAMP_spatial.year.chl_Dry Tropics__Midshelf_flntu_naturalA\res.png}}\\[1em]
  d) AIMS FLNTU fsMAMP4\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/FLNTU/eda.idx_fsMAMP4_spatial.year.chl_Dry Tropics__Midshelf_flntu_naturalA\res.png}}\\[1em]
  \caption[Spatial distribution of AIMS FLNTU Chlorophyll-a and associated indices for the Dry Tropics Midshelf zone]{Spatial distribution of AIMS FLNTU Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Dry Tropics Midshelf zone.
...
\begin{landscape}
\begin{figure}[ptbh]
  a) Satellite raw data\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Satellite/eda.spatial.year.chl_Dry Tropics__Midshelf__logB\res.png}}\\[1em]
  b) Satellite Binary\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Satellite/eda.idx_Binary_spatial.year.chl_Dry Tropics__Midshelf__naturalA\res.png}}\\[1em]
  c) Satellite fsMAMP\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Satellite/eda.idx_fsMAMP_spatial.year.chl_Dry Tropics__Midshelf__naturalA\res.png}}\\[1em]
  d) Satellite fsMAMP4\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/Satellite/eda.idx_fsMAMP4_spatial.year.chl_Dry Tropics__Midshelf__naturalA\res.png}}\\[1em]
  \caption[Spatial distribution of Satellite Chlorophyll-a and associated indices for the Dry Tropics Midshelf zone]{Spatial distribution of Satellite Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Dry Tropics Midshelf zone.
...
\begin{landscape}
\begin{figure}[ptbh]
  a) eReefs raw data\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs/eda.spatial.year.chl_Dry Tropics__Midshelf_eReefs_logB\res.png}}\\[1em]
  b) eReefs Binary\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs/eda.idx_Binary_spatial.year.chl_Dry Tropics__Midshelf_eReefs_naturalA\res.png}}\\[1em]
  c) eReefs fsMAMP\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs/eda.idx_fsMAMP_spatial.year.chl_Dry Tropics__Midshelf_eReefs_naturalA\res.png}}\\[1em]
  d) eReefs fsMAMP4\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs/eda.idx_fsMAMP4_spatial.year.chl_Dry Tropics__Midshelf_eReefs_naturalA\res.png}}\\[1em]
  \caption[Spatial distribution of eReefs Chlorophyll-a and associated indices for the Dry Tropics Midshelf zone]{Spatial distribution of eReefs Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Dry Tropics Midshelf zone.
...
\begin{landscape}
\begin{figure}[ptbh]
  a) eReefs926 raw data\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs926/eda.spatial.year.chl_Dry Tropics__Midshelf_eReefs926_logB\res.png}}\\[1em]
  b) eReefs926 Binary\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs926/eda.idx_Binary_spatial.year.chl_Dry Tropics__Midshelf_eReefs926_naturalA\res.png}}\\[1em]
  c) eReefs926 fsMAMP\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs926/eda.idx_fsMAMP_spatial.year.chl_Dry Tropics__Midshelf_eReefs926_naturalA\res.png}}\\[1em]
  d) eReefs926 fsMAMP4\\\includegraphics[align=t,width=0.8\linewidth]{{figures/Exploratory_Data_Analysis/eReefs926/eda.idx_fsMAMP4_spatial.year.chl_Dry Tropics__Midshelf_eReefs926_naturalA\res.png}}\\[1em]
  \caption[Spatial distribution of eReefs926 Chlorophyll-a and associated indices for the Dry Tropics Midshelf zone]{Spatial distribution of eReefs926 Chlorophyll-a a) samples and associated b) Binary, c) fsMAMP and d) fsMAMP4 index formulations for the Dry Tropics Midshelf zone.
...
\caption[Time series of AIMS insitu Chlorophyll-a indices]{Time series of annually aggregated Binary, fsMAMP and fsMAMP4 index formulations for AIMS insitu Chlorophyll-a across each of the Regions and Water bodies. The blue vertical bar spans from mid 2009 to mid 2011.}\label{fig:All_sources_AIMS insitu.Annual_measure.chl_zone}
\end{figure}

\begin{figure}[ptbh]
\includegraphics[width=1\linewidth]{{figures/Indices/Compare indices/All_sources_AIMS FLNTU.Annual_measure.chl_zone\res}.pdf}
\caption[Time series of AIMS FLNTU Chlorophyll-a indices]{Time series of annually aggregated Binary, fsMAMP and fsMAMP4 index formulations for AIMS FLNTU Chlorophyll-a across each of the Regions and Water bodies. The blue vertical bar spans from mid 2009 to mid 2011.}\label{fig:All_sources_AIMS flntu.Annual_measure.chl_zone}
\end{figure}

\begin{figure}[ptbh]
\includegraphics[width=1\linewidth]{{figures/Indices/Compare indices/All_sources_Satellite.Annual_measure.chl_zone\res}.pdf}
\caption[Time series of Satellite Chlorophyll-a indices]{Time series of annually aggregated Binary, fsMAMP and fsMAMP4 index formulations for Satellite Chlorophyll-a across each of the Regions and Water bodies. The blue vertical bar spans from mid 2009 to mid 2011.}\label{fig:All_sources_Satellite.Annual_measure.chl_zone}
\end{figure}


\begin{figure}[ptbh]
\includegraphics[width=1\linewidth]{{figures/Indices/Compare indices/All_sources_eReefs.Annual_measure.chl_zone\res}.pdf}
\caption[Time series of eReefs Chlorophyll-a indices]{Time series of annually aggregated Binary, fsMAMP and fsMAMP4 index formulations for eReefs Chlorophyll-a across each of the Regions and Water bodies. The blue vertical bar spans from mid 2009 to mid 2011.}\label{fig:All_sources_eReefs.Annual_measure.chl_zone}
\end{figure}

\begin{figure}[ptbh]
\includegraphics[width=1\linewidth]{{figures/Indices/Compare indices/All_sources_eReefs926.Annual_measure.chl_zone\res}.pdf}
\caption[Time series of eReefs926 Chlorophyll-a indices]{Time series of annually aggregated Binary, fsMAMP and fsMAMP4 index formulations for eReefs926 Chlorophyll-a across each of the Regions and Water bodies. The blue vertical bar spans from mid 2009 to mid 2011.}\label{fig:All_sources_eReefs926.Annual_measure.chl_zone}
\end{figure}
...
properties (such as Chlorophyll-a, total suspended solids etc) thus act as proxies for the
broader properties.  As directly measurable entities, many of these measures have long monitoring
histories and there is at least some understanding of the ecological role of these measures.
...
unlikely to be unrepresentative.  In particular, these absolute state and temporal trends in these
data are likely to be mainly representative of water conditions close to major sources of discharge. 
Moreover, the AIMS insitu data are restricted to just a subset
...
% difficult endorse
either of these sources as a primary data source on which to construct
...
The data assimilation of remotely sensed surface reflectance into the eReefs model has resulted in
...
\item Chlorophyll-a ($1/2$), TSS ($1/2\times 1/2=1/4$), SD ($1/2\times 1/2=1/4$)
\item Chlorophyll-a ($1/2$), SD ($1/2$)
\item Chlorophyll-a ($1/2$), TSS ($1/2$)
\end{itemize}

For each candidate, eReefs data with fsMAMP formulations are presented (see
...
Questions have been raised about the reliability and accuracy of the Satellite TSS (non-algal particles) as well as the
eReefs TSS and NOx data or else their suitability as good indicators.  In particularly, eReefs TSS in Midshelf and Offshore
is consistently well below the associated threshold values - so much so that the indices are virtually invariant over space and time.
...
\begin{itemize}
\item Whilst demonstrably more sensitive than either the Satellite or eReefs (with and without assimilation), the AIMS insitu data are
  likely to be spatially biased (predominantly reflecting conditions relatively close to major discharge sources) and lack the
  spatial and temporal coverage to provide representative metrics for entire GBR.
\item Although the Satellite data shows some spatial variability (except for Secchi depth), temporal variability is very subtle  
\item Assuming the eReefs assimilated modelled data encapsulates both deterministic expectations (models) and some form of observable
  realisations of state, these data should provide a solid basis on which to build water quality report card metrics.
\item eReefs TSS and NOx both appear to be very low (particularly in Midshelf and Offshore) compared to the associated
  thresholds thereby resulting in highly insensitive indices.
\item In the short-term, water quality metrics should comprise only eReefs Chlorophyll-a and Secchi depth.  
\end{itemize}
