\subsection{eReefs coupled hydrodynamic -- biogeochemical model}
...
\begin{figure}[thb]
\begin{center}
\resizebox{5in}{!}{\includegraphics{figures/Mark/ereefsbgcdiagram4emlyn.png}}
...
\begin{figure}[thb]
\begin{center} \resizebox{5in}{!}{\includegraphics{figures/Mark/EnKFschematic.pdf}}
...
\begin{figure}[thb]
\begin{center} \resizebox{5in}{!}{\includegraphics{figures/Mark/OC3M4reanalysis.png}}
...
\begin{figure}[thb]
\begin{center} \resizebox{5in}{!}{\includegraphics{figures/Mark/reanalysisRMSerror.png}}
